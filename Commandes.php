...
<html lang="fr">
    ...
    <body>
        ...
        <div class="corps1">
            <br>
            <h1 style="font-size:210%; color:rgb(0, 0, 0);">Commandes COLLEGE ET LYCEE :</h1>
        </div>

        <div class="connexion">
            <br>
            <a href="Tableau.php"> <button type="button" style="font-size:150%; color:rgb(255, 255, 255)" class="Tableau">Tableau</button></a>
            <a href="CommandesPrimaire.php"> <button type="button" style="font-size:150%; color:rgb(255, 255, 255)" class="Tableau">Primaire</button></a>
            <br>
