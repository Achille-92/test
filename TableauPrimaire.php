...
<html lang="fr">
    ...
    <body>
        ...
        <div class="corps1">
            <br>
            <h1 style="font-size:210%; color:rgb(0, 0, 0);">Tableau PRIMAIRE :</h1>
        </div>

        <div class="connexion">
            <br>
            <a href="CommandesPrimaire.php"> <button type="button" style="font-size:150%; color:rgb(255, 255, 255)" class="Commandes">Commandes</button></a>
            <br>
           ...
           $sql = "SELECT pull, couleur, taille FROM primaire";
