...
<html lang="fr">
    ...
    <body>
        ...
        <div class="corps1">
            <br><br><br>
            <h1 style="font-size:210%; color:rgb(0, 0, 0);">SWEATS A CAPUCHE AVEC ZIP</h1>
        

         <div class="corps2">
            <br><br><br>
            <div class="a1-a">
            <img src="NA.jpg" onmouseover="this.src='ND.jpg'" onmouseout="this.src='NA.jpg'">
            <img src="RAZ.jpg" onmouseover="this.src='RD.jpg'" onmouseout="this.src='RAZ.jpg'">
                <br><br>
            </div>
        ...
        <br><br>
            ...
            <div class="a1-c">
                ...
                <p style="font-size:160%;"> Le prix pour un Sweat avec zip est de 30€. Pour payer vous avez deux solutions      possibles :</p>
                <ul>
            ...
            <div class="a1-b">
                ...
                <form form action="" method="post">
                    ...
                    <p>
                      ...
                      <input type="radio" id="Rouge" name="couleur" value="Rouge" required> Rouge 
                    </p>
